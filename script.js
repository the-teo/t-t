...
const tracks = [
    ...
    { title: "late night pics", cap: "cabana lu Gemene :))", img: "url('img/2.png')" },
    { title: "random haging out", cap: "feels like centuries ago", img: "url('img/3.png')" },
...
const cookies = [
    ...
    "it's okay if today was just about being a potato.",
    ...
    "you handle things with such grace, taking the high road.",
    "i love your sense of humor.",
    "you make me feel seen and heard.",
    "i'm happier since finding you.",
    "you are full of magic (a good witch).",
